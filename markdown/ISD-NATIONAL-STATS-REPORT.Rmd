...
c2 <- c(paste0("Source database refreshed (", submission_deadline(end_date),");	Analytical work begins, involving extraction of quarterly patient observations with outcome, mapping of predictions from baseline model, calculation of observed & predicted deaths at Hospital-level calculated by aggregating outcomes and predictions, import to reporting template, internal QA and data scrutiny (data completeness); Management Information Tool made available to NHS Boards (25 January 2019)"),
paste0("Official statistics report production cycle commences; Scottish Government and NHS Boards receive standard pre-release access (5 February 2019);	ISD briefs Scottish Government on content of report (", pub_date(end_date, "current") - days(7),"); Report published on ISD website at 09:30 on Tuesday ", pub_date(end_date, "current"),"."),
...
**Table 1 – HSMR**  
Table 1 presents:
* HSMR presented on a **funnel plot** for each rolling 12 month period since, allowing comparisons to be made between each hospital and the average for Scotland for that particular period.
...
* Overall crude mortality rates (%) for deaths within 30-days of admission by specialty group
