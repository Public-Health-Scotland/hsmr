...
url_list <- data.frame(a = c(1, 2, 3, 4), 
             url = c(paste0("https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/hospital-standardised-mortality-ratios/11-february-2020/", pub_date(end_date, "current"),"/"), 
