...
chart_3 <- ggplot(trend_data %>% filter(label == "Elective" | 
  ...
  theme(panel.background = element_blank(),
    ...
    axis.title.x = element_text(size = 12, face = "bold"),
    axis.title.y = element_text(size = 12, face = "bold"),
    axis.text = element_text(size = 9, angle= 90, hjust = 0, vjust = 0.5),
    legend.title = element_blank(),
    legend.position = "top")
...
"Release of HSMR at Scotland, NHS Board and Hospital levels for the period April 2018 to March 2019. Also includes analyses of crude mortality trends over the longer term between Apr-Jun 2014 and Jan-Mar 2019.",
...
"Quarterly",
"Hospital Standardised Mortality Ratios (HSMR) for the latest 12 month period April 2018 to March 2019. Quarterly crude mortality trends from Apr-Jun 2014 to Jan-Mar 2019 (one quarter reporting lag)",
