...
<Div custom-style = "centre_justify"> ![This chart shows each hospitals HSMR for the latest 12 month period plotted on a funnel plot.](Funnel_Plot.png) The data relating to this chart can be found in [Table1](`r url_list[1,"url"]`). ***p*** Provisional </div>
