...
All hospitals have HSMRs calculated for the most recent quarters based on their current levels of data completeness. `r completeness(quarter = "current", level = "board", first_day = qtr_start)`. PHS are aware of a delayed backlog of cases from Galloway Community Hospital in the previous reporting period.
