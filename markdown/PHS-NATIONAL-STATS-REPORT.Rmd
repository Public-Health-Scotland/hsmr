...
This report by Public Health Scotland (PHS) provides Hospital Standardised Mortality Ratios (HSMR) data to assist in the continuous improvement of patient care in Scottish hospitals. NHS Boards, individual hospitals and improvement initiatives like the Scottish Patient Safety Programme work to reduce acute hospital mortality and helps to reflect on and monitor the quality of patient care. HSMRs alone cannot be used to confirm whether hospital performance is above or below average, but do provide an important starting point for further investigation.

HSMRs do not directly compare mortality rates to the national average. The mix of patients seen varies between hospitals, and the mortality rate may be higher or lower at a hospital for many reasons; the patients seen, for example, may be more seriously ill than average. HSMRs instead take account of some of the factors known to affect the risk of death, so that comparisons between individual hospitals and Scotland are made on a comparable basis.
