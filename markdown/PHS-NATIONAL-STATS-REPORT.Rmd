...
Death registrations from NRS are linked to hospital admissions in Scotland on a monthly basis. This has enabled the crude trends to include admissions up to `r format(pub_date(end_date, "current"), "%B %Y") ` in this release.  
