...
"Due to an error a number of deaths were missing from the May 2021 release of this publication. The figures reported for crude mortality within 30 days of admission and within 30 days of discharge should have been higher for the quarter Oct-Dec 2020. The correct figures for Oct-Dec 2020 are included in this release. HSMR and population-based mortality values were not affected.",
...
Please note that due to an error a number of deaths were missing from the May 2021 release of this publication. The figures reported for crude mortality within 30 days of admission and within 30 days of discharge should have been higher for the quarter Oct-Dec 2020. The correct figures for Oct-Dec 2020 are included in this release. HSMR and population-based mortality values were not affected.
...
* An HSMR value of exactly 1 means that the number of patients who died within 30 days of admission is equal to the number of predicted deaths. In other words, the risk of death matches the Scottish average risk for the patient subgroups that were seen. The HSMR value for Scotland is therefore always 1.00.
...
Chart 2 shows the overall crude hospital mortality percentage at Scotland level for deaths within 30 days of admission. The value is generally around 3%, with seasonal increases over the winter months. However, April to June 2020 saw a substantial increase above the historical average due to the impact of COVID-19. The crude mortality rate has now reduced, but remains elevated. Two factors have influenced this increase: deaths from COVID-19, and a reduction in overall patient numbers but with the more seriously ill patients still attending hospital.
...
Any improvements needed to be balanced against the overall policy strategy and purpose of the HSMR which, from 2016, was to monitor progress towards the Scottish Patient Safety Programme aim of reducing mortality by a further 10% by end December 2018.
