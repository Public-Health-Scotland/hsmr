...
This report by Public Health Scotland (PHS) provides Hospital Standardised Mortality Ratios (HSMR) data to assist in the continuous improvement of patient care in Scottish hospitals. NHS Boards, individual hospitals and improvement initiatives like the Scottish Patient Safety Programme work to reduce acute hospital mortality and this publication helps to reflect on and monitor the quality of patient care. HSMRs alone cannot be used to confirm whether hospital performance is above or below average, but do provide an important starting point for further investigation.
