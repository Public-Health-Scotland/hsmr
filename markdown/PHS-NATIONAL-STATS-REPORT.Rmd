...
url_list <- data.frame(a = c(1, 2, 3, 4), 
             url = c(paste0("https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/hospital-standardised-mortality-ratios/", format(pub_day, "%d-%B-%Y"),"/"), 
                     paste0("https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/hospital-standardised-mortality-ratios/", format(pub_day, "%d-%B-%Y"),"/"), 
                     paste0("https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/hospital-standardised-mortality-ratios/", format(pub_day, "%d-%B-%Y"),"/"), 
                     paste0("https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/hospital-standardised-mortality-ratios/", format(pub_day, "%d-%B-%Y"),"/")), 
