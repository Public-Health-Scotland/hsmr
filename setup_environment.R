...
start_date        <- lubridate::dmy(01102019)

# The beginning of baseline period/extract window for trend data
start_date_trends <- lubridate::dmy(01102017)
