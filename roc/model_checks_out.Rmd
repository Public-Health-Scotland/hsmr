...
AUC (**A**rea **U**nder the **C**urve) is a single value metric to describe the ROC curve. Because we know that a perfect curve will be a rectangle with an area of 1, we know that **an AUC close to 1 suggests better discrimination**. An AUC of 0.5 is equivalent to a random guess.
