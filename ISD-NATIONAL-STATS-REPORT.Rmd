...
funnel_plot <- ggplot(smr_data %>% filter(location_type == "hospital"), aes()) + 
  ...
  labs(x = "Number of Predicted Deaths", y = "Standardised Mortality Ratio", title = paste0("Funnel Plot: ")) +
...
chart_2 <- ggplot(trend_data %>% filter(label == "All Admissions"), 
                  aes(x = forcats::fct_reorder(quarter_full,
                                               as.numeric(quarter)), 
                      y = crd_rate,
                      group = 1)) +
  geom_line() +
...
chart_3 <- ggplot(trend_data %>% filter(label == "Elective" | label == "Non-Elective"), aes(x = forcats::fct_reorder(quarter_full,
                                               as.numeric(quarter))
                                               , y = crd_rate)) +
...
chart_3 <- ggplot(trend_data %>% filter(label == "Community" | label == "Dental" | label == "Medical" | label == "Other" | label == "Survery" | label == "Emergency" | label == "Women & Newborn"), aes(x = forcats::fct_reorder(quarter_full,
...
chart_4 <- ggplot(trend_data %>% filter(label == "0-19 years" | label == "20-39 years" | label == "40-59 years" | label == "60-79 years" | label == "80+ years"), aes(x = forcats::fct_reorder(quarter_full,
                                               as.numeric(quarter))
                                               , y = crd_rate)) +
  geom_line(aes(group=label)) +
  coord_cartesian(ylim = c(0, 7)) +
...
chart_6 <- ggplot(trend_data %>% filter(label == "1 - Most Deprived" | label == "2" | label == "3" | label == "4" | label == "5 - Least Deprived"), aes(x = forcats::fct_reorder(quarter_full,
                                               as.numeric(quarter))
                                               , y = crd_rate)) +
  geom_line(aes(group=label)) +
  coord_cartesian(ylim = c(0, 7)) +
...
chart_8 <- ggplot(trend_data %>% filter(label == "Population" & hb2014 == "Scotland"), aes(x = forcats::fct_reorder(quarter_full,
                                               as.numeric(quarter))
                                               , y = crd_rate)) +
  geom_line(aes(group=label)) +
  coord_cartesian(ylim = c(0, 7)) +
