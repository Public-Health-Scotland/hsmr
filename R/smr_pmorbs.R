...
smr_pmorbs <- function(smr01, smr01_minus5, morbs){
  ...
  smr01_minus5 %<>%
    mutate(pmorbs1_12 = replace(pmorbs1_12, pmorbs1_12 == -1 & pmorbs1_6 == 0,
                                2),
           pmorbs5_12 = replace(pmorbs5_12, pmorbs5_12 == -1 & pmorbs5_6 == 0,
                                2),
           pmorbs1_11 = replace(pmorbs1_11, pmorbs1_15 == 14 & pmorbs1_11 == 8,
                                0),
           pmorbs5_11 = replace(pmorbs5_11, pmorbs5_15 == 14 & pmorbs5_11 == 8,
                                0)) %>%
